...
#include "taichi/transforms/my_hello.h" //@syy 
#include "taichi/transforms/my_isl.h"   //@syy20240929
...
bool hello_printing(IRNode *root);//@syy
bool poly_test(IRNode *root);    //@syy20240929
