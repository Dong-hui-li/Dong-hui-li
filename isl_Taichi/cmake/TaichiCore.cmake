...
# projects.
#syy 20240930  解决符号未定义问题 (hidden-->default) 符号可见性控制
#set(CMAKE_CXX_VISIBILITY_PRESET hidden) 
set(CMAKE_CXX_VISIBILITY_PRESET default)
#syy 20241007  解决符号未定义问题 (ON->OFF) 符号可见性控制
...
message("print the path:${INSTALL_LIB_DIR}")
#syy 20241007 新增islfixed.a路径
# 假设静态库路径为 _skbuild/.mslib
set(MYLIB_PATH "${CMAKE_BINARY_DIR}/../cmake-install/lib")
...
#syy 20240928 加入isl第三方库的安装
target_include_directories(${CORE_LIBRARY_NAME} PRIVATE external/isl/isl-0.22/include)
#syy 20241007 加入isl第三方库的安装
#target_include_directories(${CORE_LIBRARY_NAME} PRIVATE ${MYLIB_PATH}/include)
...
if(TI_WITH_PYTHON)
    ...
    if (NOT ANDROID)
        ...
        #syy 1007 新增库
        #pybind11_add_module(${CORE_WITH_PYBIND_LIBRARY_NAME} NO_EXTRAS ${TAICHI_PYBIND_SOURCE} ${MYLIB_PATH}/libisl_fixed.a)
    ...
    if (LINUX)
        # syy20240929 test shared folder
        #target_link_options(${CORE_WITH_PYBIND_LIBRARY_NAME} PUBLIC -Wl,--exclude-libs=ALL)
        target_link_options(${CORE_WITH_PYBIND_LIBRARY_NAME} PUBLIC)
        if (NOT ANDROID)
            # Excluding Android
    ...
    #syy 1007 将libislfixed.a链接到CORE_WITH_PYBIND_LIBRARY_NAME
    # target_link_libraries(${CORE_WITH_PYBIND_LIBRARY_NAME} PRIVATE ${MYLIB_PATH}/libisl_fixed.a)
    ...
    target_include_directories(${CORE_WITH_PYBIND_LIBRARY_NAME}
      PRIVATE
        ...
        #syy 20240928
        ${PROJECT_SOURCE_DIR}/external/isl/isl-0.22/include
        #syy 20241007
        #${MYLIB_PATH}/include
      )
